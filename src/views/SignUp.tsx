    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#EDEDEE' }}>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-2" style={{ color: '#68768A' }}>Start planning your life today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              style={{
                border: `1.5px solid ${
                  usernameStatus === 'invalid' ? '#B91C1C' : usernameStatus === 'ok' ? '#059669' : '#C8C8C8'
                }`,
                background: '#F2F2F2',
                color: '#111',
              }}
            ...
            {usernameStatus === 'ok' && (
              <p className="text-xs mt-1" style={{ color: '#059669' }}>Username looks good.</p>
            )}
          </div>

          <div>
            <label className="block text-xs font-semibold uppercase tracking-wide mb-1.5" style={{ color: '#1B2A4A' }}>
              Display Name <span style={{ color: '#C8C8C8', fontWeight: 400 }}>(optional)</span>
            </label>
            <input
              type="text"
              value={displayName}
          ...
          <div>
            ...
            />
            <p className="text-xs mt-1" style={{ color: '#9CA3AF' }}>Minimum 6 characters.</p>
          </div>
